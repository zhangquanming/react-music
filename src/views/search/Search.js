      ...
      <div className="music-search skin-search">
        <div className={`${style.searchBoxWrapper} skin-search-box-wrapper`}>
          ...
          <div
            ...
            onClick={() => this.setState({ w: '', singer: {}, album: {}, songs: [] })}
          >
            取消
          </div>
        </div>
        ...
        <div className={`${style.searchResult} skin-search-result`} style={{ display: this.state.w ? 'block' : 'none' }}>
          <Scroll>
            <div>
              {/*专辑*/}
              <div className="album-wrapper" style={{ display: album.id ? 'block' : 'none' }} onClick={this.handleClick(album.mId, 'album')}>
              ...
              {/* 歌手 */}
              <div className="singer-wrapper" style={{ display: singer.id ? 'block' : 'none' }} onClick={this.handleClick(singer.mId, 'singer')}>
                <div className={style.left}>
                ...
                <div className={style.right}>
                  ...
                  <div className="info">
                    单曲{singer.songNum} 专辑{singer.albumNum}
                  </div>
                </div>
              </div>
              {/* 歌曲列表 */}
