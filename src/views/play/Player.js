...
import './player.styl';
import playBgImg from '../../assets/imgs/play_bg.jpg';
...
class Player extends React.Component {
  ...
  render() {
    ...
    let playBg = song.img ? song.img : playBgImg;
              ...
              <div className="controller-wrapper">
                <div className="progress-wrapper">
                  ...
                  <div className="play-progress">
                    <Progress progress={this.state.playProgress} onClick={this.handleClick} onDrag={this.handleDrag} onDragEnd={this.handleDragEnd} />
                  </div>
